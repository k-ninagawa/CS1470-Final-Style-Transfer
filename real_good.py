...
def main():
    ...
    height = sys.argv[2]
    width = sys.argv[3]
    content_path = tf.keras.utils.get_file('ken.jpg', 'https://scontent.fzty2-1.fna.fbcdn.net/v/t1.0-9/69497958_2478425912438909_3450352180421197824_n.jpg?_nc_cat=101&_nc_ohc=0_3juOlM8QoAQmzBbRpDJPHGrl0StwoAOWDEaP_qYYCuRfKXOUS_8nJNQ&_nc_ht=scontent.fzty2-1.fna&oh=9f3cf33e29a3d668e30dae71b36f9a27&oe=5E834777')
    ...
    content_targets_1 = extractor.style_content(content_image_1)[0]
    content_targets = extractor.style_content(content_image)[0]
